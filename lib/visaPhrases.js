...
(function () {
  ...
  const SPONSOR_PATTERNS = [
    ...
    // "Will consider sponsoring …" family — Capital One, Microsoft, Wells
    // Fargo, and many others use these as the standard sponsor-friendly
    // phrasing. Negative variants ("will not consider sponsoring", "not
    // eligible for sponsorship") are listed in NO_SPONSOR_PATTERNS above
    // and matched first, so a refusal can't false-positive here.
    'consider sponsoring',
